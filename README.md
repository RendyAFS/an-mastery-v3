...
[![Version](https://img.shields.io/badge/App_Version-v1.1.1-6d9886?style=for-the-badge)](config/app.php)
...
- **Footer Landing Page**
- **Dynamic PWA Service Worker** (`/sw.js` -> `CACHE_NAME = "an-mastery-v1.1.1"`)
