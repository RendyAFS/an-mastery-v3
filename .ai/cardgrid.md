...
## Tujuan
Dokumen ini menjelaskan panduan lengkap penggunaan komponen grid kartu dinamis **CardGrid** di proyek ini. Panduan ini mencakup penggunaan Blade component, inisialisasi Javascript, konfigurasi opsi, dan format respons backend.
