...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Validasi Bahasa Garis
    |--------------------------------------------------------------------------
    |
    | Bahasa baris berikut berisi pesan error default yang digunakan oleh
    ...
    */
    ...
    'between'         => [
        ...
        'file'    => 'Bidang :attribute harus berada di antara :min dan :max kilobyte.',
    ...
    'encoding'          => 'Bidang :attribute harus di-encode dalam :encoding.',
    ...
    'password'         => [
        ...
        'uncompromised' => 'Password :attribute telah muncul dalam kebocoran data. Silakan pilih password yang berbeda.',
    ],
    ...
    'required_without_all'   => 'Bidang :attribute wajib diisi ketika tidak ada dari :values yang ada.',
    ...
    'unique'      => 'Bidang :attribute sudah ada.',
