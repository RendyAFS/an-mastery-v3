...
class SaveSablonRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'total_long_fabric'                     => 'required|numeric|min:0',
            'total_sablon'                          => 'required|numeric|min:0',
            ...
            'fabric_details.*.long_fabric'          => 'required|numeric|min:0',
            ...
            'employee_details.*.additional_fee'     => 'nullable|numeric|min:0',
