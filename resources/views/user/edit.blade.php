@extends('layouts.main', ['title' => __('crud.edit_title', ['model' => __('models.User')])])
...
@section('content')
    <form id="user-form" data-mode="edit" data-id="{{ $user->id }}" class="max-w-6xl mx-auto">
        <div
            ...
            <div class="p-4 md:p-5">
                <p class="text-2xl font-bold text-(--color-dark) dark:text-(--color-light)">
                    {{ __('crud.edit_title', ['model' => __('models.User')]) }}
                </p>
