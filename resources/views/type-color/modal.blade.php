    ...
    <div
        ...
        <div
            ...
            <div
                ...
                <h3 id="hs-type-color-modal-label" class="font-semibold text-(--color-dark) dark:text-(--color-light)">
                    Type Color
                </h3>
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-type-color-modal">
