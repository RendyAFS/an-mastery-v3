@extends('layouts.main', ['title' => 'Edit Color Fabric'])

@push('scripts')
    @vite('resources/js/pages/color-fabric/form.js')
@endpush

@section('content')
    <form id="color-fabric-form" data-mode="edit" data-id="{{ $colorFabric->id }}" class="max-w-4xl mx-auto">
        <div
            ...
            <div class="p-4 md:p-5">
                ...
                <div class="mt-6">
                    @include('color-fabric.form', ['colorFabric' => $colorFabric])
                </div>
            </div>
            ...
            <div
                ...
                <a href="{{ route('color_fabrics.index') }}"
