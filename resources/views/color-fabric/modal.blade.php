    ...
    <div
        ...
        <div
            ...
            <div
                ...
                <h3 id="hs-color-fabric-modal-label" class="font-semibold text-(--color-dark) dark:text-(--color-light)">
                    Color Fabric
                </h3>
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-color-fabric-modal">
            ...
            <div class="p-4 overflow-y-auto">
                <form id="color-fabric-form" data-mode="create">
                    @include('color-fabric.form', ['colorFabric' => null])
                    ...
                    <div class="flex gap-2 pt-2">
                        ...
                        <button type="button" data-hs-overlay="#hs-color-fabric-modal"
