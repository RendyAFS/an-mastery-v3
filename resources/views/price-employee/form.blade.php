<div class="grid grid-cols-2 gap-3">
    <div class="coll-span-1">
        <x-select id="type_fabric_id" name="type_fabric_id" label="Type Fabric" :options="$typeFabrics" :value="$priceEmployee->type_fabric_id ?? null"
            placeholder="Choose Type Fabric" search-placeholder="Search type fabric..." clearable="true" />
    </div>

    <div class="coll-span-1">
        <x-select id="type_color_id" name="type_color_id" label="Type Color" :options="$typeColors" :value="$priceEmployee->type_color_id ?? null"
