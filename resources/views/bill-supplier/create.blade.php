...
@section('content')
    <form id="bill-supplier-form" data-mode="create" data-supplier-id="{{ $supplier->id }}"
        ...
        <div
            ...
            <div
                ...
                <a href="{{ route('bill_suppliers.by-supplier', ['supplier' => $supplier->id, 'week_start' => request('week_start'), 'week_end' => request('week_end')]) }}"
