        ...
        <template x-for="(row, index) in employeeRows" :key="row.uid">
            <div class="rounded-lg border p-4"
                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <button type="button" @click="removeEmployeeRow(index)" x-show="!row.locked && !row.is_paid"
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div class="relative" @click.outside="row.openEmp = false">
                            <button type="button" @click="row.openEmp = !row.openEmp"
                                ...
                                <div class="flex items-center gap-2">
                                    <span x-show="row.employee_id && !row.locked && !row.is_paid"
                                        @click.stop="row.employee_id = ''"
                            ...
                            <div x-show="row.openEmp && !row.locked && !row.is_paid" x-cloak
                    ...
                    <div class="flex items-center gap-2 pt-5">
                        <input type="checkbox" x-model="row.is_bon" :disabled="row.locked || row.is_paid"
                            class="checkbox-custom" :id="'bon_' + row.uid">
                        ...
                        <template x-for="(af, afIndex) in row.additionalFees" :key="af.uid">
                            <div
                                ...
                                <div class="col-span-1 group relative">
                                    ...
                                    <textarea x-model="af.notes" rows="3" maxlength="255" :disabled="row.locked || row.is_paid"
