<div id="hs-supplier-modal"
    class="hs-overlay hidden size-full fixed top-0 start-0 z-80 overflow-x-hidden overflow-y-auto pointer-events-none"
    role="dialog" tabindex="-1" aria-labelledby="hs-supplier-modal-label">
    ...
    <div
        ...
        <div
            ...
            <div
                ...
                <h3 id="hs-supplier-modal-label" class="font-semibold text-(--color-dark) dark:text-(--color-light)">
                    Color Fabric
                </h3>
                <button type="button"
                    ...
                    aria-label="Close" data-hs-overlay="#hs-supplier-modal">
            ...
            <div class="p-4 overflow-y-auto">
                <form id="supplier-form" data-mode="create">
                    @include('supplier.form', ['supplier' => null])
                    ...
                    <div class="flex gap-2 pt-2">
                        ...
                        <button type="button" data-hs-overlay="#hs-supplier-modal"
