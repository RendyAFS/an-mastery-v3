    ...
    <div class="space-y-6">
        ...
        <x-datatable id="employees-datatable" filterId="filter-employees">
            <thead class="border-b">
                <tr>
                    <th class="bg-(--color-light-gray) dark:bg-(--color-dark-slate) px-6 py-3 text-start text-xs font-medium text-muted-foreground-1 uppercase">Name</th>
                    <th class="bg-(--color-light-gray) dark:bg-(--color-dark-slate) px-6 py-3 text-start text-xs font-medium text-muted-foreground-1 uppercase">
