<form id="bonus-form" data-mode="create">
    <x-modal id="hs-bonus-modal" title="{{ __('models.Bonus') }}" size="lg">
        @include('bonus.form', ['bonus' => null])
        ...
        <x-slot:footer>
            ...
            <button type="button" data-hs-overlay="#hs-bonus-modal"
