@extends('layouts.main', ['title' => __('crud.add_title', ['model' => __('models.Gallery')])])

@push('scripts')
    @vite('resources/js/pages/gallery/form.js')
@endpush

@section('content')
    <form id="gallery-form" data-mode="create" class="max-w-6xl mx-auto">
        <div
            ...
            <div class="p-4 md:p-5">
                ...
                <div class="mt-6">
                    @include('gallery.form', ['gallery' => null])
                </div>
            </div>
            ...
            <div
                ...
                <x-button-loading type="submit" :text="__('button-loading.Save')" :loadingText="__('button-loading.Saving...')"
