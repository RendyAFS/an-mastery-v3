<x-modal id="hs-image-fabric-viewer" size="lg" :scrollable="false" :centered="true">
    <div
        ...
        <button type="button" data-hs-overlay="#hs-image-fabric-viewer"
            class="absolute top-2 right-2 size-8 flex items-center justify-center rounded-full
            bg-(--color-dark)/60 text-white hover:bg-(--color-dark)/80 cursor-pointer z-10">
